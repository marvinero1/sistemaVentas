...
<div class="content-wrapper pt-3">
    <h1 style="text-align: center" class="mb-4">Despacho</h1>
<div class="content">
    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                   <!--  <td><a class="image-popup-vertical-fit" href="/{{  $despacho->imagen }}">
                        <img img src="/{{ $despacho->imagen }}" class="img-thumbnail" alt="articulo" height="100px"
                            width="100px" style="display: block;margin: 0 auto;">
                    </a></td> -->
                        <td style="text-align:center;">{{ $despacho->name }}</td>
                        <td style="text-align:center;">{{ $despacho->email }}</td>
                        <td style="text-align:center;">{{ $despacho->telefono }}</td>
                        <td style="text-align:center;">{{ $despacho->whatsapp }}</td>
                        <td style="text-align:center;">{{ $despacho->rol }}</td>

                        <td style="text-align:center;">
                          <div class="card-body">
                               <form action="{{ route('user.destroy', $despacho->id ) }}" method="POST"
